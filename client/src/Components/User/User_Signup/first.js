            ...
            <Grid >
                <form>
                    ...
                    <TextField
                        ...
                        required
                    />
                    <FormControl sx={{ marginTop: "1%" }} fullWidth required variant="outlined">
                    ...
                    >
                        <Grid item sx={{ width: "50%" }}>
                            <Typography variant="body2" gutterBottom>*Password must contain atleast one uppercase character,one lowercase character, two digits and one special character, and minimum length of 8 (without containing space).</Typography>
                        </Grid>
                        <Grid item sx={{ width: "50%" }}>
                            <Button onClick={props.nextfun} variant="contained" sx={{ "&:hover": { backgroundColor: "#9C7875" }, width: "50%", display: 'flex', marginLeft: "auto", color: 'white', backgroundColor: '#9C7875' }} >
                                Next
                            </Button>
                        </Grid>
                    </Grid>
