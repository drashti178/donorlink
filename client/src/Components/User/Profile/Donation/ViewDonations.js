...
const ViewDonation = () => {
    ...
    return (
        <>
            ...
            {
                (inputs.length == 0) ? <Typography variant="h6" gutterBottom style={{marginTop:"3%",marginLeft:"1%"}}>You haven't donated in any Ngo yet!! <Button onClick={() => {navigate('/user/home')}}>click here</Button> to make donation.</Typography> :
