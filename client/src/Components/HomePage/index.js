...
const Home = () => {
  ...
  return (
    ...
    <div
      ...
      >
        <Typography variant="h3" style={{ color: "#08b9c0",textAlign:'center',width:"50%",marginInline:"25%",marginTop:"10%" }}>
      ...
      <Grid container >
        <Grid item xs={5} >
          ...
          <Typography variant='h4'>Children in 190 countries in the world</Typography></Item>
        </Grid>
        <Grid item xs={3}>
    ...
    <Box style={{ flexGrow: 1,marginInline:"8%",marginTop:"10%",height:"200px",display:"flex",flexDirection:"row",marginBlockEnd:"8%"}}>
            ...
            <Box style={{display:"flex",flexDirection:"row",padding:"2%"}}>
              <Diversity1OutlinedIcon fontSize='large' style={{fontSize:"80px",color:"darkcyan"}} />
