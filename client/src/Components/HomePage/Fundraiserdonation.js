...
const Fundraiserdonation = () => {
    const location=useLocation();
    const fr_id = location.state;
    ...
    const initPayment = () => {
        if (localStorage.getItem("AccessToken") == null && inputs.amount <= 2000) {
            ...
            const options = {
                ...
                handler: async () => {
                    await axios.post(`${base_url}/auth/fdonation/update/${fr_id}/${inputs.amount}`, {
                        headers: {
            ...
            const options = {
                ...
                handler: async () => {
                    await axios.post(`${base_url}/donation/fundraiser/${fr_id}/${inputs.amount}`, {}, {
                        headers: {
                            'Authorization': token,
                        }
                    }).then(
...
export default Fundraiserdonation