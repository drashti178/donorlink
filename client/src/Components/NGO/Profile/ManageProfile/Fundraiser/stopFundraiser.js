...
const StopFundraiser = (props) => {
  ...
  return (
   ...
   <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
     ...
     <DialogTitle id="form-dialog-title"  sx={{display:"flex",marginLeft:"auto", color: 'darkcyan', width:"80%" }}>Stop Fundraiser Activity</DialogTitle>
