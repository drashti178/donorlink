...
const ViewFDonations = (props) => {
  ...
  return (
    ...
    <Button 
        variant="contained"
        sx={{ "&:hover": { backgroundColor: "darkcyan", color: 'white', },marginLeft:"100%", marginTop:"2%",width: "20%", backgroundColor: 'darkcyan' ,color:"white"}} onClick={handleClickOpen}>Donations</Button>
   <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
     
     <DialogContent>
     <form onSubmit={handleSubmit}>
     <DialogTitle id="form-dialog-title"  sx={{display:"flex",marginLeft:"auto", color: 'darkcyan', width:"80%" }}>View Fundraiser Donation</DialogTitle>
